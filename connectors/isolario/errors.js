const ISOLARIO_WEBSOCKET_DUPLICATE_ENTRY = 255;
const ISOLARIO_WEBSOCKET_HANDSHAKE_ERROR = 254;
const ISOLARIO_WEBSOCKET_TOKEN_ERROR = 253;
const ISOLARIO_WEBSOCKET_AUTHENTICATION_ERROR = 252;
const ISOLARIO_WEBSOCKET_PERMISSION_ERROR = 251;
const ISOLARIO_WEBSOCKET_DUPLICATE_CONNECTION = 250;
const ISOLARIO_PARAMETER_ERROR = 249;
const ISOLARIO_EXPIRED_GUEST = 248;
const APP_NOT_AVAILABLE = 256;
const SERVER_EXPIRED = 257;
const FEEDER_DEATH_ERROR = 258;
