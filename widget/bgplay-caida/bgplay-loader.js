...
require.config({
    paths: {
        ...
        "caida-facade": BGPLAY_CONNECTORS_URL + "caida/CaidaFacade",
        ...
        "config": BGPLAY_WIDGET_URL + "bgplay-caida/bgplay-config",
        "modules": BGPLAY_WIDGET_URL + "bgplay-caida/bgplay-modules",
