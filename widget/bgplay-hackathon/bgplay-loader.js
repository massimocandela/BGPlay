...
require.config({
    paths: {
        ...
        "hackathon-facade": BGPLAY_CONNECTORS_URL + "hackvizFacade",
        ...
        "config": BGPLAY_WIDGET_URL + "bgplay-hackathon/bgplay-config",
        "modules": BGPLAY_WIDGET_URL + "bgplay-hackathon/bgplay-modules",
